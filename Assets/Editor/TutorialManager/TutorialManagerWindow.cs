...
namespace UnityEngine.Analytics
{
    ...
    {
        private readonly static string k_PluginVersion = "0.0.1-alpha";
        ...
        private void OnGUI()
        {
            if (UnityEditor.Analytics.AnalyticsSettings.enabled)
            {
                ...
                var tutorials = TMParser.manifest.tutorials;
                var steps = TMParser.manifest.steps;

                var tutorialTable = TMParser.manifest.tutorialTable;
                var stepsTable = TMParser.manifest.stepTable;
        ...
        void RenderTutorial(Tutorial tutorial) {
            ...
            {
                foreach (string s in tutorial.steps) {
                    Step step = TMParser.manifest.stepTable[s];
